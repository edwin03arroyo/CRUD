...
# Form implementation generated from reading ui file 'Interfaz_Nueva_F.ui'
#
...
"")
        ...
        self.label_21 = QtWidgets.QLabel(self.page_registrar)
        ...
        self.reg_apellido = QtWidgets.QLineEdit(self.page_registrar)
        self.reg_apellido.setObjectName("reg_apellido")
        self.verticalLayout_11.addWidget(self.reg_apellido)
        self.reg_cedula = QtWidgets.QLineEdit(self.page_registrar)
        self.reg_cedula.setObjectName("reg_cedula")
        self.verticalLayout_11.addWidget(self.reg_cedula)
        self.reg_telefono = QtWidgets.QLineEdit(self.page_registrar)
        self.reg_telefono.setObjectName("reg_telefono")
        self.verticalLayout_11.addWidget(self.reg_telefono)
        ...
        self.act_apellido = QtWidgets.QLineEdit(self.layoutWidget_3)
        self.act_apellido.setObjectName("act_apellido")
        self.verticalLayout_14.addWidget(self.act_apellido)
        self.act_cedula = QtWidgets.QLineEdit(self.layoutWidget_3)
        self.act_cedula.setObjectName("act_cedula")
        self.verticalLayout_14.addWidget(self.act_cedula)
        self.act_edad = QtWidgets.QLineEdit(self.layoutWidget_3)
        self.act_edad.setObjectName("act_edad")
        self.verticalLayout_14.addWidget(self.act_edad)
        self.horizontalLayout_8.addLayout(self.verticalLayout_14)
        self.label_32 = QtWidgets.QLabel(self.page_actulizar)
        self.label_32.setGeometry(QtCore.QRect(170, 0, 331, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Facturacion Registrados"))
        ...
        item.setText(_translate("MainWindow", "Id_Reser"))
        item = self.tabla_productos.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Fech_Factu"))
        item = self.tabla_productos.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Meto_Pago"))
        item = self.tabla_productos.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Total"))
        self.bt_refrescar.setText(_translate("MainWindow", "Actulizar"))
        self.label_19.setText(_translate("MainWindow", "Agregar Facturacion"))
        self.label_5.setText(_translate("MainWindow", "Codigo"))
        self.label_4.setText(_translate("MainWindow", "ID_Reserva"))
        self.label_2.setText(_translate("MainWindow", "Fecha"))
        self.label_3.setText(_translate("MainWindow", "Metodo"))
        self.label_21.setText(_translate("MainWindow", "Total"))
        self.bt_agregar.setText(_translate("MainWindow", "Agregar"))
        self.label_24.setText(_translate("MainWindow", "Codigo"))
        self.label_26.setText(_translate("MainWindow", "ID_Reserva"))
        self.label_27.setText(_translate("MainWindow", "Fecha"))
        self.label_28.setText(_translate("MainWindow", "Metodo"))
        self.label_31.setText(_translate("MainWindow", "Total"))
        self.label_32.setText(_translate("MainWindow", "Actualizacion de Facturacion"))
        self.bt_actualiza_tabla.setText(_translate("MainWindow", "Actualizar"))
        self.label_33.setText(_translate("MainWindow", "ID de Factura:"))
        self.bt_actualiza_buscar.setText(_translate("MainWindow", "Buscar"))
        self.label_56.setText(_translate("MainWindow", "Eliminar Facturas"))
        ...
        item.setText(_translate("MainWindow", "Id_Reserva"))
        ...
        item.setText(_translate("MainWindow", "Total"))
        self.pushButton.setText(_translate("MainWindow", "Buscar Facturacion"))
