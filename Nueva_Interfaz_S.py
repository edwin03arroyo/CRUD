...
# Form implementation generated from reading ui file 'Interfaz_Nueva_S.ui'
#
...
"")
        ...
        self.reg_nombreS = QtWidgets.QLineEdit(self.page_registrar)
        self.reg_nombreS.setObjectName("reg_nombreS")
        self.verticalLayout_11.addWidget(self.reg_nombreS)
        self.reg_costo = QtWidgets.QLineEdit(self.page_registrar)
        self.reg_costo.setObjectName("reg_costo")
        self.verticalLayout_11.addWidget(self.reg_costo)
        ...
        self.act_costo = QtWidgets.QLineEdit(self.layoutWidget_3)
        self.act_costo.setObjectName("act_costo")
        self.verticalLayout_14.addWidget(self.act_costo)
        self.horizontalLayout_8.addLayout(self.verticalLayout_14)
        self.label_32 = QtWidgets.QLabel(self.page_actulizar)
        self.label_32.setGeometry(QtCore.QRect(170, 0, 281, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Servicios Registrados"))
        ...
        item.setText(_translate("MainWindow", "Nombre_Ser"))
        ...
        self.label_19.setText(_translate("MainWindow", "Agregar Servicio"))
        ...
        self.label_31.setText(_translate("MainWindow", "Costo"))
        self.label_32.setText(_translate("MainWindow", "Actualizacion de Servicio"))
        ...
        self.label_56.setText(_translate("MainWindow", "Eliminar Servicio"))
        ...
        item.setText(_translate("MainWindow", "Costo"))
        self.pushButton.setText(_translate("MainWindow", "Buscar Servicio"))
