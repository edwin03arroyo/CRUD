...
# Form implementation generated from reading ui file 'Interfaz_Nueva_R.ui'
#
...
"")
        ...
        self.reg_numReser = QtWidgets.QLineEdit(self.page_registrar)
        self.reg_numReser.setObjectName("reg_numReser")
        self.verticalLayout_11.addWidget(self.reg_numReser)
        self.reg_servicio = QtWidgets.QLineEdit(self.page_registrar)
        self.reg_servicio.setObjectName("reg_servicio")
        self.verticalLayout_11.addWidget(self.reg_servicio)
        self.reg_nomClien = QtWidgets.QLineEdit(self.page_registrar)
        self.reg_nomClien.setObjectName("reg_nomClien")
        self.verticalLayout_11.addWidget(self.reg_nomClien)
        ...
        self.act_numServi = QtWidgets.QLineEdit(self.layoutWidget_3)
        self.act_numServi.setObjectName("act_numServi")
        self.verticalLayout_14.addWidget(self.act_numServi)
        self.act_Servicio = QtWidgets.QLineEdit(self.layoutWidget_3)
        self.act_Servicio.setObjectName("act_Servicio")
        self.verticalLayout_14.addWidget(self.act_Servicio)
        self.act_Cliente = QtWidgets.QLineEdit(self.layoutWidget_3)
        self.act_Cliente.setObjectName("act_Cliente")
        self.verticalLayout_14.addWidget(self.act_Cliente)
        self.horizontalLayout_8.addLayout(self.verticalLayout_14)
        self.label_32 = QtWidgets.QLabel(self.page_actulizar)
        self.label_32.setGeometry(QtCore.QRect(190, 0, 281, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "N° De Reserva"))
        item = self.tabla_productos.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Servicio a Reservar"))
        ...
        self.label_19.setText(_translate("MainWindow", "Agregar Reserva"))
        self.label_5.setText(_translate("MainWindow", "Codigo"))
        self.label_6.setText(_translate("MainWindow", "N° Reserva"))
        self.label_4.setText(_translate("MainWindow", "Servicio"))
        self.label_2.setText(_translate("MainWindow", "Nombre_Cliente"))
        self.bt_agregar.setText(_translate("MainWindow", "Agregar"))
        self.label_24.setText(_translate("MainWindow", "Codigo"))
        self.label_25.setText(_translate("MainWindow", "N° Servicio"))
        self.label_26.setText(_translate("MainWindow", "Servicio"))
        self.label_27.setText(_translate("MainWindow", "Cliente"))
        self.label_32.setText(_translate("MainWindow", "Actualizacion Reserva"))
        self.bt_actualiza_tabla.setText(_translate("MainWindow", "Actualizar"))
        self.label_33.setText(_translate("MainWindow", "Nombre de la Reserva:"))
        self.bt_actualiza_buscar.setText(_translate("MainWindow", "Buscar"))
        self.label_56.setText(_translate("MainWindow", "Eliminar Reserva"))
        ...
        item.setText(_translate("MainWindow", "N° Reservacion"))
        ...
        item.setText(_translate("MainWindow", "Servicio Reservado"))
        item = self.tabla_buscar.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "ID_Cliente"))
        self.pushButton.setText(_translate("MainWindow", "Buscar Reserva"))
